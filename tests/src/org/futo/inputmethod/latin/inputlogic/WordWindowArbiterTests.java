...
public class WordWindowArbiterTests {
    ...
    public void testGapZeroAlwaysStartFreshAndInert() {
        ...
        // First tap.
        assertEquals(WordWindowArbiter.Decision.START_FRESH, a.onStartInput(0, false));
        ...
        assertEquals(WordWindowArbiter.Decision.START_FRESH, a.onStartInput(0, true));
        assertFalse(a.isWindowOpen());
    }
    ...
    public void testNegativeGapTreatedAsOff() {
        ...
        assertEquals(WordWindowArbiter.Decision.START_FRESH, a.onStartInput(-1, false));
        assertFalse(a.isWindowOpen());
    }
    ...
    public void testFirstInputOpensWindowStartFresh() {
        final WordWindowArbiter a = newArbiter(1000L);
        assertFalse(a.isWindowOpen());
        assertEquals(WordWindowArbiter.Decision.START_FRESH, a.onStartInput(200, false));
        ...
        assertEquals(WordWindowArbiter.Decision.START_FRESH, b.onStartInput(200, true));
    ...
    public void testExtendWithinGap() {
        final FakeClock clock = new FakeClock(1000L);
        final WordWindowArbiter a = new WordWindowArbiter(clock);
        a.onStartInput(200, false);                      // tap, opens window
        a.recordInputEnd(1000L, false);
        clock.t = 1100L;                                 // 100 < 200 ⇒ EXTEND
        assertEquals(WordWindowArbiter.Decision.EXTEND, a.onStartInput(200, false));
        assertTrue(a.isWindowOpen());
        assertFalse(a.windowHasSwipe());
        a.recordInputEnd(1100L, false);
        clock.t = 1190L;                                 // 90 < 200 ⇒ EXTEND with a swipe
        assertEquals(WordWindowArbiter.Decision.EXTEND, a.onStartInput(200, true));
    ...
    public void testFirstSwipeExtendsSlowTapPrefix() {
        ...
        clock.t = 14000L;
        assertEquals(WordWindowArbiter.Decision.COMMIT_THEN_START, a.onStartInput(200, false));
    }
    ...
    public void testCancelledSecondSwipeKeepsFirstSwipe() {
        ...
        assertEquals(WordWindowArbiter.Decision.START_FRESH, a.onStartInput(200, true));
    ...
    public void testOnWindowResetClosesEverything() {
        final FakeClock clock = new FakeClock(1000L);
        final WordWindowArbiter a = new WordWindowArbiter(clock);
        a.onStartInput(200, true);                        // opens swipe window
        a.recordInputEnd(1000L, true);
        assertTrue(a.isWindowOpen());
        assertTrue(a.windowHasSwipe());
        a.onWindowReset();
    ...
    public void testJustUnderGapExtends() {
        final FakeClock clock = new FakeClock(1000L);
        final WordWindowArbiter a = new WordWindowArbiter(clock);
        a.onStartInput(200, true);                       // arm the timer with a swipe
        a.recordInputEnd(1000L, true);
    ...
    public void testTogglingFeatureOffMidWindowResetsToStock() {
        final FakeClock clock = new FakeClock(1000L);
        final WordWindowArbiter a = new WordWindowArbiter(clock);
        a.onStartInput(200, true);                        // builds a swipe-window
        a.recordInputEnd(1000L, true);
